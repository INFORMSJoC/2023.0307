...
class CartpoleConfig(BaseMuZeroConfig):
    def __init__(self):
        super(CartpoleConfig, self).__init__(
            ...
            search_budget=50,  # 10, 20, 30, 40, 50, 60
            batch_size=128,
            td_steps=5,
            lr_init=0.05,
            lr_decay_rate=0.01,
    ...
    def new_game(self, save_video=False, save_path=None, episode_trigger: Callable[[int], bool] = None, uid=None):
        ...
        return CartpoleWrapper(env, discount=self.discount, k=4)
