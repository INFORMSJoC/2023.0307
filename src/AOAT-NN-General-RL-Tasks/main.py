...
if __name__ == '__main__':
    ...
    # import corresponding configuration , neural networks and environment
    from config.cartpole import muzero_config
    ...
    try:
        if args.opr == 'train':
            ray.init()
            if args.use_wandb:
                wandb.init(project="muzero-cartpole", sync_tensorboard=True,  config=muzero_config.get_hparams())
